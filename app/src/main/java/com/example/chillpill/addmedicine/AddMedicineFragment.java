...
import com.example.chillpill.R;
import com.example.chillpill.alarm.ReminderActivity;
import com.example.chillpill.alarm.ReminderFragment;
import com.example.chillpill.data.source.MedicineAlarm;
import com.example.chillpill.data.source.Pills;
import com.example.chillpill.views.DayViewCheckBox;
import com.example.chillpill.views.RobotoBoldTextView;
...
public class AddMedicineFragment extends Fragment implements AddMedicineContract.View {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.activity_fragment_add_medicine, container, false);
